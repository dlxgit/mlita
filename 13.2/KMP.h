...
size_t KMP(const vector<int> & prefixFunction, const string & text, const string & pattern, const vector<size_t> & stringSizeList, const int & beginIndex); //returns next to found pattern's index
